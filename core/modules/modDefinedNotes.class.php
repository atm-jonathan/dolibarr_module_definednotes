...
/**
 * 	\defgroup   definednotes     Module DefinedNotes
 *  \brief      Example of a module descriptor.
 *				Such a file must be copied into htdocs/definednotes/core/modules directory.
 *  \file       htdocs/definednotes/core/modules/modDefinedNotes.class.php
 *  \ingroup    definednotes
 *  \brief      Description and activation file for module DefinedNotes
 */
include_once DOL_DOCUMENT_ROOT .'/core/modules/DolibarrModules.class.php';


/**
 *  Description and activation class for module DefinedNotes
 */
class modDefinedNotes extends DolibarrModules
{
	/**
	...
	function __construct($db)
	{
		...
		$this->rights_class = 'definednotes';
		...
		// for specific css file (eg: /definednotes/css/definednotes.css.php)
		...
		//							'css' => array('/definednotes/css/definednotes.css.php'),	// Set this to relative path of css file if module has its own css file
		...
		// Example: this->dirs = array("/definednotes/temp");
		$this->dirs = array();

		// Config pages. Put here list of php page, stored into definednotes/admin directory, to use to setup module.
		$this->config_page_url = array("definednotes_setup.php@definednotes");
		...
		// Example: $this->tabs = array('objecttype:+tabname1:Title1:definednotes@definednotes:$user->rights->definednotes->read:/definednotes/mynewtab1.php?id=__ID__',  	// To add a new tab identified by code tabname1
        //                              'objecttype:+tabname2:Title2:definednotes@definednotes:$user->rights->othermodule->read:/definednotes/mynewtab2.php?id=__ID__',  	// To add another new tab identified by code tabname2
...
*/
		...
		// $this->menu[$r]=array(	'fk_menu'=>'fk_mainmenu=definednotes',		// Put 0 if this is a single top menu or keep fk_mainmenu to give an entry on left
		//							'type'=>'top',			                // This is a Top menu entry
		//							'titre'=>'DefinedNotes top menu',
		//							'mainmenu'=>'definednotes',
		//							'leftmenu'=>'definednotes_left',			// This is the name of left menu for the next entries
		...
		// $this->menu[$r]=array(	'fk_menu'=>'fk_mainmenu=definednotes,fk_leftmenu=definednotes_left',		    // Use 'fk_mainmenu=xxx' or 'fk_mainmenu=xxx,fk_leftmenu=yyy' where xxx is mainmenucode and yyy is a leftmenucode
		//							'type'=>'left',			                // This is a Left menu entry
		//							'titre'=>'DefinedNotes left menu',
		//							'mainmenu'=>'definednotes',
		//							'leftmenu'=>'definednotes_left',			// Goes into left menu previously created by the mainmenu
		//							'url'=>'/definednotes/pagelevel2.php',
		//							'langs'=>'definednotes@definednotes',	        // Lang file to use (without .lang) by module. File must be in langs/code_CODE/ directory.
		//							'position'=>100,
...
/*
		...
		$this->menu[$r]=array(
			'fk_menu'=>'fk_mainmenu=definednotes',			                // Put 0 if this is a top menu
			'type'=>'left',			                // This is a Top menu entry
			'titre'=>$langs->trans('TopMenuDefinedNotes'),
			'mainmenu'=>'definednotes',
			'leftmenu'=>'definednotes_left',
			'url'=>'/definednotes/list.php',
			'langs'=>'definednotes@definednotes',	        // Lang file to use (without .lang) by module. File must be in langs/code_CODE/ directory.
			'position'=>100+$r,
			'enabled'=>'$conf->definednotes->enabled',	// Define condition to show or hide menu entry. Use '$conf->missionorder->enabled' if entry must be visible if module is enabled.
		...
		$this->menu[$r]=array(
			...
			'type'=>'left',			                // This is a Left menu entry
			'titre'=>$langs->trans('LeftMenuDefinedNotesCreate'),
			'mainmenu'=>'definednotes',
			'leftmenu'=>'definednotes_left_create',
			'url'=>'/definednotes/card.php?action=create',
			'langs'=>'definednotes@definednotes',	        // Lang file to use (without .lang) by module. File must be in langs/code_CODE/ directory.
			'position'=>100+$r,
		...
		$this->menu[$r]=array(
			'fk_menu'=>'fk_mainmenu=definednotes,fk_leftmenu=definednotes_left',		    // Use 'fk_mainmenu=xxx' or 'fk_mainmenu=xxx,fk_leftmenu=yyy' where xxx is mainmenucode and yyy is a leftmenucode
			'type'=>'left',			                // This is a Left menu entry
			'titre'=>$langs->trans('LeftMenuDefinedNotesList'),
			'mainmenu'=>'definednotes',
			'leftmenu'=>'definednotes_left_list',
			'url'=>'/definednotes/list.php',
			'langs'=>'definednotes@definednotes',	        // Lang file to use (without .lang) by module. File must be in langs/code_CODE/ directory.
			'position'=>100+$r,
			'enabled'=> '$conf->definednotes->enabled',  // Define condition to show or hide menu entry. Use '$conf->missionorder->enabled' if entry must be visible if module is enabled. Use '$leftmenu==\'system\'' to show if leftmenu system is selected.
...
*/
	...
	function init($options='')
	{
		...
		dol_include_once('/definednotes/script/create-maj-base.php');

		$result=$this->_load_tables('/definednotes/sql/');
